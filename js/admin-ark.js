...
function renderAdminArk(scrollTilBunn) {
  ...
  const kolonner = [
    ...
    {title:'Fullmakt', field:'fullmaktVis', minWidth:70, headerSort:false, hozAlign:'center',
    ...
    {title:'Vedtak', field:'vedtakVis', minWidth:70, headerSort:false, hozAlign:'center',
